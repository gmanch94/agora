...
- 610 tests across unit, property (Hypothesis on compensator  symmetry), and end-to-end (FastAPI + ASGITransport + in-memory
...
- `docs/adr/0001-…` … `0015-staff-console-htmx-jinja2.md` — architecture decisions (20 docs; latest: 0014 routing-LLM tie-breaker, 0015 staff console HTMX+Jinja2)
